...
var ionicPortals = (function (exports, core) {
    ...
    class PortalsAndroid {
        async publish(message) {
            return core.Plugins.Portals.publishNative(message);
        }
        async subscribe(options, callback) {
            return new Promise((res) => {
                let subscribed = false;
                core.Plugins.Portals.subscribeNative(options, (result) => {
                    if (!subscribed) {
                        res(result);
                        subscribed = true;
                    }
        ...
        async unsubscribe(options) {
            return core.Plugins.Portals.unsubscribeNative(options);
        }
    }
